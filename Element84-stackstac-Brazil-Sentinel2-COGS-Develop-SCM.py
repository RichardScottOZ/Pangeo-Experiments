...
datetime_b = "2020-04-22/2021-04-22"
...
#stack = stackstac.stack(stac_items, epsg=6933, resolution=20000, resampling=1)
...
b02, b03 = cropped_clear.sel(band="SCL"), cropped_clear.sel(band="SCL")
print(b02)
...
if 1 == 1:
    with dask.diagnostics.ProgressBar():
        ...
        croppedNP.rio.to_raster(r'F:\Brazil\sentinel_median_carajas_grav_SCM_60_0.tif')
